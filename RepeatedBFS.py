...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 23 23:53:34 2021
    ...
    def aStar(self,x,y,matrix):
        ...
        while self.queue.__len__() > 0:
            ...
            for i in range(0,4):
                ...
                x_temp = RepeatedBFS.x_cord[i] + curr_x
                y_temp = RepeatedBFS.y_cord[i] + curr_y
    ...
    def findPath(self):
        ...
        for tuplecoord in findpathrev:
            ...
            if self.matrix[coordx][coordy]==0:
                ...
                for i in range(0,4):
                    x_temp = RepeatedBFS.x_cord[i] + coordx
                    y_temp = RepeatedBFS.y_cord[i] + coordy
                    if (x_temp >=0 and x_temp < self.size and y_temp >=0 and y_temp <self.size):
